...
{
    public partial class ManageScreener : BasePage
    {
        ...
        private string Save()
        {
            ...
            try
            {
                var repo = new ScreenerRepository();
                var record = JsonConvert.DeserializeObject<Screener>(Request["record"]);
        ...
        private string GetById()
        {
            ...
            try
            {
                result = JsonConvert.SerializeObject(new ScreenerRepository().GetById(id));
            }
            catch (Exception ex)
            {
                result = ex.Message;
        ...
        private string GetDataTable()
        {
            ...
            var dal = new ScreenerRepository();
