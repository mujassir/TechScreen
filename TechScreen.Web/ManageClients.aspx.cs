    ...
    public partial class ManageClients : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (key == "")
            {
                 ...
                 ddltlclients.DataSource = records;
                 ddltlclients.DataBind();
                 return;
            }
            string data = null;
            switch (key)
        ...
        private string Save()
        {
            ...
            {
                var repo = new ClientRepository();
                var record = JsonConvert.DeserializeObject<Client>(Request["record"]);
        ...
        private string GetById()
        {
            ...
            try
            {
                result = JsonConvert.SerializeObject(new ClientRepository().GetById(id));
            }
            catch (Exception ex)
            {
                result = ex.Message;
        ...
        {
            var coloumns = new[] { "Name", "Email", "TopLevelClientName", "State", "City", "PhonePrimary", "" };
